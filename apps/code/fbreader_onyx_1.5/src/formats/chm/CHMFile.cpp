...
CHMInputStream::CHMInputStream(fb::shared_ptr<ZLInputStream> base, const CHMFileInfo::SectionInfo &sectionInfo, size_t offset, size_t size) : myBase(base), mySectionInfo(sectionInfo), mySize(size) {
...
fb::shared_ptr<ZLInputStream> CHMFileInfo::entryStream(fb::shared_ptr<ZLInputStream> base, const std::string &name) const {
...
CHMFileInfo::FileNames CHMFileInfo::sectionNames(fb::shared_ptr<ZLInputStream> base) const {
	FileNames names;
	fb::shared_ptr<ZLInputStream> stringsStream = entryStream(base, "/#STRINGS");
