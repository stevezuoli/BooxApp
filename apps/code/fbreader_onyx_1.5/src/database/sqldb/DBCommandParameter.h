...
public:
	...
	DBCommandParameter(fb::shared_ptr<DBValue> value); 

	// create named parameter with specified value:
	DBCommandParameter(const std::string &name, fb::shared_ptr<DBValue> value); 

public:
	const std::string &name() const;
	void setName(const std::string &name);

	fb::shared_ptr<DBValue> value() const;
	void setValue(fb::shared_ptr<DBValue> value);
...
inline fb::shared_ptr<DBValue> DBCommandParameter::value() const { return myValue; }
inline void DBCommandParameter::setValue(fb::shared_ptr<DBValue> value) { myValue = value; }
