...
public:
	DataBase(fb::shared_ptr<DBConnection> connection);
	virtual ~DataBase();
...
private:
	fb::shared_ptr<DBConnection> myConnection;
...
inline DataBase::DataBase(fb::shared_ptr<DBConnection> connection) : myConnection(connection) { }
