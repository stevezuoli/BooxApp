...
DBCommandParameter::DBCommandParameter(fb::shared_ptr<DBValue> value) 
...
DBCommandParameter::DBCommandParameter(const std::string &name, fb::shared_ptr<DBValue> value) 
