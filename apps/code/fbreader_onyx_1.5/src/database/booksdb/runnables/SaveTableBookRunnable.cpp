...
bool SaveTableBookRunnable::run() {
	...
	fb::shared_ptr<DBValue> dbBookId = myFindBookId->executeScalar();
...
bool SaveTableBookRunnable::addTableBook(const fb::shared_ptr<DBBook> book, int fileId) {
	...
	fb::shared_ptr<DBValue> dbBookId = myAddBook->executeScalar();
...
bool SaveTableBookRunnable::updateTableBook(const fb::shared_ptr<DBBook> book) {
