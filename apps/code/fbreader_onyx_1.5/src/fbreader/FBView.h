...
private:
	static fb::shared_ptr<ZLTextPositionIndicatorInfo> ourIndicatorInfo;
	static fb::shared_ptr<FBMargins> ourMargins;
	static fb::shared_ptr<ZLBooleanOption> ourSelectionOption;

protected:
	void doTapScrolling(int y);

public:
	FBView(FBReader &reader, fb::shared_ptr<ZLPaintContext> context);
...
protected:
	...
	fb::shared_ptr<ZLTextPositionIndicatorInfo> indicatorInfo() const;
