...
fb::shared_ptr<ZLTextPositionIndicatorInfo> FBView::ourIndicatorInfo;
fb::shared_ptr<FBMargins> FBView::ourMargins;
fb::shared_ptr<ZLBooleanOption> FBView::ourSelectionOption;
...
FBView::FBView(FBReader &reader, fb::shared_ptr<ZLPaintContext> context) : ZLTextView(reader, context) {
}

fb::shared_ptr<ZLTextPositionIndicatorInfo> FBView::indicatorInfo() const {
	if (ourIndicatorInfo.isNull()) {
		ourIndicatorInfo = new FBIndicatorStyle();
	}
