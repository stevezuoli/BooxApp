...
void ZLQtApplicationWindow::keyReleaseEvent(QKeyEvent *event) {
    ...
    if (!application().isTextSelectionEnabled())
    {
        ...
        case Qt::Key_PageDown:
            application().doAction("largeScrollForward");
            break;
        case Qt::Key_Right:
            application().doAction("redo");
            break;
        case Qt::Key_PageUp:
            application().doAction("largeScrollBackward");
            break;
        case Qt::Key_Left:
...
void ZLQtApplicationWindow::updateScreen()
{
    ...
    {
        onyx::screen::instance().updateWidget(this, onyx::screen::ScreenProxy::INVALID, true, onyx::screen::ScreenCommand::WAIT_ALL);
    }
}
