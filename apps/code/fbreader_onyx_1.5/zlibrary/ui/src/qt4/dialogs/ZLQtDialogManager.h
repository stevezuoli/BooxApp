...
public:
	...
	fb::shared_ptr<ZLDialog> createDialog(const ZLResourceKey &key) const;
	fb::shared_ptr<ZLOptionsDialog> createOptionsDialog(const ZLResourceKey &key, fb::shared_ptr<ZLRunnable> applyAction, bool showApplyButton) const;
