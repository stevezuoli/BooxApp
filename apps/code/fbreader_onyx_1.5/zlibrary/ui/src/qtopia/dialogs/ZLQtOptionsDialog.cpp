...
ZLQtOptionsDialog::ZLQtOptionsDialog(const ZLResource &resource, fb::shared_ptr<ZLRunnable> applyAction) : ZLFullScreenDialog(std::string()), ZLOptionsDialog(resource, applyAction) {
