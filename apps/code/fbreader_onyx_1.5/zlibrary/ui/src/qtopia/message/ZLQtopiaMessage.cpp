...
fb::shared_ptr<ZLMessageOutputChannel> ZLQtopiaCommunicationManager::createMessageOutputChannel(const std::string &protocol, const std::string &testFile) {
	if (protocol != "QCop") {
		return 0;
	}
...
fb::shared_ptr<ZLMessageSender> ZLQCopMessageOutputChannel::createSender(const ZLCommunicationManager::Data &data) {
