...
ZLView::ZLView(ZLApplication &application, fb::shared_ptr<ZLPaintContext> context) : myApplication(application), myViewWidget(0), myContext(context) {
}
...
void ZLView::setPaintContext(fb::shared_ptr<ZLPaintContext> context) {
	myContext = context;
}

void ZLViewWidget::setView(fb::shared_ptr<ZLView> view) {
	if (myView != 0) {
