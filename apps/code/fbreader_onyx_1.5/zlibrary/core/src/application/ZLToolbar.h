...
public:
	...
	public:
		...
		fb::shared_ptr<ZLPopupData> popupData() const;
...
public:
	typedef fb::shared_ptr<Item> ItemPtr;
...
private:
	...
	std::map<std::string, fb::shared_ptr<ZLPopupData> > myPopupDataMap;
	std::map<std::string, fb::shared_ptr<ButtonGroup> > myButtonGroups;
