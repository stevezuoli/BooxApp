...
public:
  ...
  protected:
    ...
    void addAction(const std::string &actionId, fb::shared_ptr<Action> action);
    void registerPopupData(const std::string &actionId, fb::shared_ptr<ZLPopupData> popupData);

    void setView(fb::shared_ptr<ZLView> view);
    fb::shared_ptr<ZLView> currentView() const;
  ...
  public:
    ...
    fb::shared_ptr<ZLPaintContext> context();
    ...
    fb::shared_ptr<Action> action(const std::string &actionId) const;
    ...
    virtual fb::shared_ptr<ZLKeyBindings> keyBindings();
  ...
  private:
    ...
    fb::shared_ptr<ZLView> myInitialView;
    std::map<std::string,fb::shared_ptr<Action> > myActionMap;
    mutable fb::shared_ptr<ZLToolbar> myToolbar;
    mutable fb::shared_ptr<ZLToolbar> myFullscreenToolbar;
    mutable fb::shared_ptr<ZLMenubar> myMenubar;
    fb::shared_ptr<ZLPaintContext> myContext;
    class ZLApplicationWindow *myWindow;
    ZLTime myLastKeyActionTime;
    fb::shared_ptr<ZLMessageHandler> myPresentWindowHandler;
