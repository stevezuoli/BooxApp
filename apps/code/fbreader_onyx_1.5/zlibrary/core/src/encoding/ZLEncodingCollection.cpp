...
void ZLEncodingCollection::registerProvider(fb::shared_ptr<ZLEncodingConverterProvider> provider) {
...
const std::vector<fb::shared_ptr<ZLEncodingConverterProvider> > &ZLEncodingCollection::providers() const {
	return myProviders;
}

const std::vector<fb::shared_ptr<ZLEncodingSet> > &ZLEncodingCollection::sets() {
	init();
	return mySets;
}
...
fb::shared_ptr<ZLEncodingConverter> ZLEncodingCollection::defaultConverter() {
