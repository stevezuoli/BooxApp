...
public:
	ZLColorComboOptionEntry(fb::shared_ptr<ZLColorOptionsData> data);
...
private:
	fb::shared_ptr<ZLColorOptionsData> myData;
};

class ZLMultiColorOptionEntry : public ZLColorOptionEntry {

public:
	ZLMultiColorOptionEntry(fb::shared_ptr<ZLColorOptionsData> data);
...
ZLColorComboOptionEntry::ZLColorComboOptionEntry(fb::shared_ptr<ZLColorOptionsData> data) : myData(data) {
}
...
ZLMultiColorOptionEntry::ZLMultiColorOptionEntry(fb::shared_ptr<ZLColorOptionsData> data) : myData(data) {
}
