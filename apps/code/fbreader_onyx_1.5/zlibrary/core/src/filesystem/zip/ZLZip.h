...
private:
	ZLZipInputStream(fb::shared_ptr<ZLInputStream> &base, const std::string &entryName);
...
private:
	fb::shared_ptr<ZLInputStream> myBaseStream;
	...
	fb::shared_ptr<ZLZDecompressor> myDecompressor;
...
private:
	ZLGzipInputStream(fb::shared_ptr<ZLInputStream> stream);
