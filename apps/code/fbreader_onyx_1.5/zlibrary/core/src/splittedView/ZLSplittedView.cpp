...
ZLSplittedView::ZLSplittedView(ZLApplication &application, fb::shared_ptr<ZLPaintContext> context) : ZLView(application, context), myMoveSplitter(false) {
}
...
void ZLSplittedView::setLeftView(fb::shared_ptr<ZLView> view) {
	myLeftView = view;
...
void ZLSplittedView::setRightView(fb::shared_ptr<ZLView> view) {
	myRightView = view;
