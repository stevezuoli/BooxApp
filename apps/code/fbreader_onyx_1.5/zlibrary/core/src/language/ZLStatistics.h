...
public:
	virtual fb::shared_ptr<ZLStatisticsItem> begin() const = 0;
	virtual fb::shared_ptr<ZLStatisticsItem> end() const = 0;
...
public:
	...
	virtual fb::shared_ptr<ZLStatisticsItem> begin() const;
	virtual fb::shared_ptr<ZLStatisticsItem> end() const;
