...
ZLOptionsDialog::ZLOptionsDialog(const ZLResource &resource, fb::shared_ptr<ZLRunnable> applyAction) : TabOption(ZLCategoryKey::LOOK_AND_FEEL, resource.name(), "SelectedTab", ""), myResource(resource), myApplyAction(applyAction) {
}
