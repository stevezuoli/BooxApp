...
public:
	...
	virtual fb::shared_ptr<ZLDialog> createDialog(const ZLResourceKey &key) const = 0;
	virtual fb::shared_ptr<ZLOptionsDialog> createOptionsDialog(const ZLResourceKey &key, fb::shared_ptr<ZLRunnable> applyAction = 0, bool showApplyButton = false) const = 0;
