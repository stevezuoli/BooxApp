...
ZLOptionView::ZLOptionView(const std::string &name, const std::string &tooltip, fb::shared_ptr<ZLOptionEntry> option) : myName(name), myTooltip(tooltip), myOption(option), myInitialized(false) {
