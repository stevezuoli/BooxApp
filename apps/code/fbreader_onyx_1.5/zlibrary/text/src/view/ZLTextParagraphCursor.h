...
public:
	...
	ZLTextControlElement *getControlElement(fb::shared_ptr<ZLTextParagraphEntry> entry);
...
typedef fb::shared_ptr<ZLTextParagraphCursor> ZLTextParagraphCursorPtr;
...
private:
    static std::map<const ZLTextParagraph*, fb::weak_ptr<ZLTextParagraphCursor> > ourCache;
...
inline ZLTextControlElement *ZLTextElementPool::getControlElement(fb::shared_ptr<ZLTextParagraphEntry> entry) {
