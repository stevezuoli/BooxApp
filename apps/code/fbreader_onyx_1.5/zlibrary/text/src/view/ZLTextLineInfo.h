...
struct ZLTextLineInfo {
	...
	fb::shared_ptr<ZLTextTreeNodeInfo> NodeInfo;
...
class ZLTextLineInfoPtr : public fb::shared_ptr<ZLTextLineInfo> {
...
inline ZLTextLineInfoPtr::ZLTextLineInfoPtr(ZLTextLineInfo *ptr) : fb::shared_ptr<ZLTextLineInfo>(ptr) {}
