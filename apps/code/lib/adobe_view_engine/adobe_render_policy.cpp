...
AdobeRenderPolicy::AdobeRenderPolicy()
    : RenderPolicy()
{
}
...
void AdobeRenderPolicy::getRenderRequests(const int current_page,
...
void AdobeRenderPolicy::nextPagesFirst( const int current_page,
                                        const int total,
                                        bool forward,
                                        QVector<int> & result )
{
...
void AdobeRenderPolicy::farawayPagesFirst( const int current_page,
                                           const int total,
                                           bool forward,
                                           QVector<int> & result )
{
...
void AdobeRenderPolicy::nearPagesFirst( const int current_page,
                                        const int total,
                                        QVector<int> & result )
{
    // current + 1
