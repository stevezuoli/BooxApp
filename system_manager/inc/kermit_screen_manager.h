...
#ifndef KERMIT_SCREEN_MANAGER_H_
#define KERMIT_SCREEN_MANAGER_H_
...
/// Kermit screen manager.
class KermitScreenManager : public ScreenManagerInterface
{
    Q_OBJECT
public:
    KermitScreenManager();
...
public:
    ...
    void drawLine(onyx::screen::ScreenCommand & command);
...
private:
    ...
    uchar *kermit_buffer_;       ///< The kermit framebuffer address.
    int kermit_buffer_size_;
...
#endif      // KERMIT_SCREEN_MANAGER_H_
