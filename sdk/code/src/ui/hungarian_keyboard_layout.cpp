...
HungarianKeyboardLayout::HungarianKeyboardLayout()
: KeyboardLayout()
{
    initCode();
    initShiftMap();
...
QSize HungarianKeyboardLayout::getKeySize(int code)
{
    const int space = 4;
...
void HungarianKeyboardLayout::initCode()
{
    code_vector_.clear();
    ...
    code_vector_.push_back(QChar(0x00C1));   //A acute  // 26
    code_vector_.push_back(QChar(0x00E1));   //a acute  // 27
    code_vector_.push_back(QChar(0x00C9));  //E acute   // 28
    code_vector_.push_back(QChar(0x00E9));  //e acute   // 29
    code_vector_.push_back(QChar(0x00CD));  //I acute   // 30
    code_vector_.push_back(QChar(0x00ED));  //i acute  // 31
    code_vector_.push_back(QChar(0x00D3));   //O acute  // 32
    code_vector_.push_back(QChar(0x00F3));   //o acute  // 33
    code_vector_.push_back(QChar(0x00D6));  //O double dot above   // 34
    code_vector_.push_back(QChar(0x00F6));  //o double dot above   // 35
    code_vector_.push_back(QChar(0x0150));  //O double acute   // 36
    code_vector_.push_back(QChar(0x0151));  //o double acute   // 37
    code_vector_.push_back(QChar(0x00DA));  //U acute  // 38
    code_vector_.push_back(QChar(0x00FA));  //u acute   // 39
    code_vector_.push_back(QChar(0x00DC));  //U double dot above   // 40
    code_vector_.push_back(QChar(0x00FC));  //u double dot above   // 41
    code_vector_.push_back(QChar(0x0170));  //U double acute  // 42
    code_vector_.push_back(QChar(0x0171));  //u double acute  // 43
    code_vector_.push_back(QChar('.'));  //dot  // 44
}

void HungarianKeyboardLayout::initKeys()
{
    qDebug() << Q_FUNC_INFO;
    // resize keys
    keys_.clear();
...
void HungarianKeyboardLayout::initShiftMap()
{
    qDebug() << Q_FUNC_INFO;
